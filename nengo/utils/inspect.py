...
def checked_call(func, *args, **kwargs):
    """Calls func(*args, **kwargs) and checks that invocation was successfull.

    The namedtuple `(value=func(*args, **kwargs), invoked=True)` is returned if
    the call is successfull. If an exception occurs inside of `func`, then
